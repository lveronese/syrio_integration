...
//
// Definitions for schema: services.entrasp.interprise.it
//  file:/home/luca/kepler-ws/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/entrasp/wsdl/loadservice.wsdl#types1
//
//
// Definitions for schema: http://services.entrasp.interprise.it/
//  file:/home/luca/kepler-ws/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/entrasp/wsdl/loadservice.wsdl#types2
//
//
// Constructor for XML Schema item {http://services.entrasp.interprise.it/}result
//
function services_entrasp_interprise_it__result () {
    this.typeMarker = 'services_entrasp_interprise_it__result';
    this._errors = '';
    this._returnData = '';
}

//
// accessor is services_entrasp_interprise_it__result.prototype.getErrors
// element get for errors
// - element type is {http://www.w3.org/2001/XMLSchema}string
// - required element
//
// element set for errors
// setter function is is services_entrasp_interprise_it__result.prototype.setErrors
//
function services_entrasp_interprise_it__result_getErrors() { return this._errors;}

services_entrasp_interprise_it__result.prototype.getErrors = services_entrasp_interprise_it__result_getErrors;

function services_entrasp_interprise_it__result_setErrors(value) { this._errors = value;}

services_entrasp_interprise_it__result.prototype.setErrors = services_entrasp_interprise_it__result_setErrors;
//
// accessor is services_entrasp_interprise_it__result.prototype.getReturnData
// element get for returnData
// - element type is {http://www.w3.org/2001/XMLSchema}string
// - required element
//
// element set for returnData
// setter function is is services_entrasp_interprise_it__result.prototype.setReturnData
//
function services_entrasp_interprise_it__result_getReturnData() { return this._returnData;}

services_entrasp_interprise_it__result.prototype.getReturnData = services_entrasp_interprise_it__result_getReturnData;

function services_entrasp_interprise_it__result_setReturnData(value) { this._returnData = value;}

services_entrasp_interprise_it__result.prototype.setReturnData = services_entrasp_interprise_it__result_setReturnData;
//
// Serialize {http://services.entrasp.interprise.it/}result
//
function services_entrasp_interprise_it__result_serialize(cxfjsutils, elementName, extraNamespaces) {
    var xml = '';
    if (elementName != null) {
     xml = xml + '<';
     xml = xml + elementName;
    ...
    {
     xml = xml + '<errors>';
     xml = xml + cxfjsutils.escapeXmlEntities(this._errors);
     xml = xml + '</errors>';
    }
    // block for local variables
    {
     xml = xml + '<returnData>';
     xml = xml + cxfjsutils.escapeXmlEntities(this._returnData);
     xml = xml + '</returnData>';
    }
    if (elementName != null) {
     xml = xml + '</';
...
services_entrasp_interprise_it__result.prototype.serialize = services_entrasp_interprise_it__result_serialize;

function services_entrasp_interprise_it__result_deserialize (cxfjsutils, element) {
    var newobject = new services_entrasp_interprise_it__result();
    cxfjsutils.trace('element: ' + cxfjsutils.traceElementName(element));
    var curElement = cxfjsutils.getFirstElementChild(element);
    var item;
    cxfjsutils.trace('curElement: ' + cxfjsutils.traceElementName(curElement));
    cxfjsutils.trace('processing errors');
    var value = null;
    if (!cxfjsutils.isElementNil(curElement)) {
     value = cxfjsutils.getNodeText(curElement);
     item = value;
    }
    newobject.setErrors(item);
    var item = null;
    if (curElement != null) {
     curElement = cxfjsutils.getNextElementSibling(curElement);
    }
    cxfjsutils.trace('curElement: ' + cxfjsutils.traceElementName(curElement));
    cxfjsutils.trace('processing returnData');
    var value = null;
    if (!cxfjsutils.isElementNil(curElement)) {
     value = cxfjsutils.getNodeText(curElement);
     item = value;
    }
    newobject.setReturnData(item);
    var item = null;
    if (curElement != null) {
     curElement = cxfjsutils.getNextElementSibling(curElement);
    }
...
//
// Definitions for service: {http://services.entrasp.interprise.it/}LoadService
//

// Javascript for {http://services.entrasp.interprise.it/}ILoadService

export function services_entrasp_interprise_it__ILoadService () {
    this.jsutils = new CxfApacheOrgUtil();
    this.jsutils.interfaceObject = this;
    this.synchronous = false;
    this.url = 'http://localhost:8080/entrasp/services/LoadServicePort';
    this.client = null;
    this.response = null;
    this.globalElementSerializers = [];
    this.globalElementDeserializers = [];
    this.globalElementSerializers['{http://services.entrasp.interprise.it/}result'] = services_entrasp_interprise_it__result_serialize;
    this.globalElementDeserializers['{http://services.entrasp.interprise.it/}result'] = services_entrasp_interprise_it__result_deserialize;
    this.globalElementSerializers['{http://services.entrasp.interprise.it/}result'] = services_entrasp_interprise_it__result_serialize;
    this.globalElementDeserializers['{http://services.entrasp.interprise.it/}result'] = services_entrasp_interprise_it__result_deserialize;
}

function services_entrasp_interprise_it__process_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling services_entrasp_interprise_it__processResponse_deserializeResponse');
     responseObject = services_entrasp_interprise_it__processResponse_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

services_entrasp_interprise_it__ILoadService.prototype.process_onsuccess = services_entrasp_interprise_it__process_op_onsuccess;

function services_entrasp_interprise_it__process_op_onerror(client) {
...
services_entrasp_interprise_it__ILoadService.prototype.process_onerror = services_entrasp_interprise_it__process_op_onerror;

//
// Operation {http://services.entrasp.interprise.it/}process
...
// - type {http://www.w3.org/2001/XMLSchema}string
//
function services_entrasp_interprise_it__process_op(successCallback, errorCallback, codiceAzienda, codicePartner, input, check, dataRecordName, extSysName) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(6);
    args[0] = codiceAzienda;
    args[1] = codicePartner;
    args[2] = input;
    args[3] = check;
    args[4] = dataRecordName;
    args[5] = extSysName;
    xml = this.process_serializeInput(this.jsutils, args);
    ...
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = 'urn:Process';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

services_entrasp_interprise_it__ILoadService.prototype.process = services_entrasp_interprise_it__process_op;

function services_entrasp_interprise_it__process_serializeInput(cxfjsutils, args) {
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='http://services.entrasp.interprise.it/' ");
    xml = xml + '<jns0:process>';
    // block for local variables
    {
     xml = xml + '<codiceAzienda>';
     xml = xml + cxfjsutils.escapeXmlEntities(args[0]);
     xml = xml + '</codiceAzienda>';
    }
    // block for local variables
    {
     xml = xml + '<codicePartner>';
...
services_entrasp_interprise_it__ILoadService.prototype.process_serializeInput = services_entrasp_interprise_it__process_serializeInput;

function services_entrasp_interprise_it__processResponse_deserializeResponse(cxfjsutils, partElement) {
    ...
    cxfjsutils.trace('rpc element: ' + cxfjsutils.traceElementName(partElement));
    var returnObject = services_entrasp_interprise_it__result_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function services_entrasp_interprise_it__ILoadService_services_entrasp_interprise_it__LoadServicePort () {
  this.url = 'http://localhost:8080/entrasp/services/LoadServicePort';
}
services_entrasp_interprise_it__ILoadService_services_entrasp_interprise_it__LoadServicePort.prototype = new services_entrasp_interprise_it__ILoadService;
